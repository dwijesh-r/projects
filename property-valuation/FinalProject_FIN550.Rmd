...
author: "Dwijesh Reddy NallappaReddy, Nikhil Reddy Satti, Rushali Naikoti"
date: "2023-11-24"
...
Time to run the whole file: 25mins on Mac M2 
...
prediction_df$accessed_value <- predict(random_forest_model, newdata = prediction_data)
```
...
prediction_data <- prediction_df %>%
  select(pid,accessed_value)


# Specify the file path where you want to save the CSV file
file_path <- "/Users/nikhilreddy/Documents/Gies/Semester 1/Projects/FIN_Project/assessed_value.csv"

# Use write.csv() to write the data frame to a CSV file
write.csv(prediction_data, file = file_path, row.names = FALSE)

# Check the created CSV file
read_csv_file <- read.csv(file_path)
print(read_csv_file)
